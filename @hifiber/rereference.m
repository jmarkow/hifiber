...
%upd=hifiber.proc_timer(length(OBJ));
...
for i=1:length(OBJ)
	...
	case 'v'
		...
		for j=to_reref
			...
			% dff is seeming less and less useful over time...
	...
	case 'i'
		...
		% if the user wants to smooth and normalize, do it, then get dat reference
		...
		% use the appropriate demixed component to reref (or just keep it hanging out...)
